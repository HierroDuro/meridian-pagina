...
/** @type {Array<{sku:string,name:string,description:string,brand:string,categorySlug:string,price:number,stock:number,isFeatured:boolean,isOnSale:boolean,salePrice?:number}>} */
export const products = [
  ...
  { sku: "KST-MF430", name: "Multifunción InkTank KST-MF430 WiFi", description: "Impresora multifunción con conectividad WiFi, impresión dúplex automática y bandeja de 250 hojas.", brand: "Kestrel", categorySlug: "tecnologia", price: 249999, stock: 9, isFeatured: true, isOnSale: false },
  ...
  { sku: "IFL-BT5001C", name: "Botella de tinta InkFlow Cyan 70ml", description: "Botella de tinta original cian de alto rendimiento, compatible con impresoras de sistema continuo.", brand: "InkFlow", categorySlug: "tecnologia", price: 8900, stock: 120, isFeatured: false, isOnSale: true, salePrice: 6900 },
  { sku: "IFL-BT5001M", name: "Botella de tinta InkFlow Magenta 70ml", description: "Botella de tinta original magenta de alto rendimiento, compatible con impresoras de sistema continuo.", brand: "InkFlow", categorySlug: "tecnologia", price: 8900, stock: 98, isFeatured: false, isOnSale: true, salePrice: 6900 },
  ...
  { sku: "MRL-MS220", name: "Mouse inalámbrico Marlin MS-220", description: "Mouse inalámbrico de 6 botones con sensor óptico de 1600 DPI y batería de larga duración.", brand: "Marlin Tech", categorySlug: "tecnologia", price: 22900, stock: 75, isFeatured: false, isOnSale: true, salePrice: 17900 },
  { sku: "MRL-WC50", name: "Webcam Full HD Marlin WC-50", description: "Webcam 1080p con micrófono integrado y corrección automática de luz, ideal para videollamadas.", brand: "Marlin Tech", categorySlug: "tecnologia", price: 56000, stock: 18, isFeatured: true, isOnSale: false },
  ...
  { sku: "PGP-COLOR", name: "Resma A4 Color Pastel PagePro", description: "Resma de papel A4 de colores pastel surtidos, 100 hojas, ideal para presentaciones.", brand: "PagePro", categorySlug: "resmas", price: 9500, stock: 40, isFeatured: false, isOnSale: true, salePrice: 7500 },
  ...
  { sku: "CHW-BLOCKA4", name: "Block de Notas A4 Rayado ChromaWorks", description: "Block de notas A4 rayado de 80 hojas, encuadernado superior, tapa dura.", brand: "ChromaWorks", categorySlug: "resmas", price: 4200, stock: 200, isFeatured: false, isOnSale: true, salePrice: 3400 },
  ...
  { sku: "GRL-BANNER", name: "Rollo Banner Satinado GraphLine", description: "Rollo de papel banner satinado de 1.27m x 30m para impresión de gran formato.", brand: "GraphLine", categorySlug: "grafica", price: 76000, stock: 9, isFeatured: false, isOnSale: true, salePrice: 62000 },
  ...
  { sku: "CHW-LAMIN", name: "Laminadora A3 ChromaWorks Pro", description: "Laminadora de rodillos en caliente y frío, formato A3, encendido rápido en 3 minutos.", brand: "ChromaWorks", categorySlug: "grafica", price: 145000, stock: 6, isFeatured: true, isOnSale: false },
